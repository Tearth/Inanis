...
[
    [
        [
            ...
            s!(1049, 1027), s!(1035, 1088), s!(1056, 1051), s!(1057, 1049), s!(1069, 1049), s!(1080, 1056), s!(1080, 1063), s!(1075, 1059),
            s!(1037, 1030), s!(1056, 1018), s!(1053, 1045), s!(1067, 1029), s!(1068, 1035), s!(1083, 1042), s!(1077, 1049), s!(1082, 1025),
            s!(1042, 1079), s!(1051, 1047), s!(1064, 1011), s!(1063, 1026), s!(1074, 1025), s!(1075, 1014), s!(1093,  975), s!(1031, 1002),
        ...
        [
            ...
            s!(1079, 1055), s!(1068, 1082), s!(1075, 1089), s!(1072, 1101), s!(1071, 1104), s!(1100, 1106), s!(1101, 1091), s!(1075, 1101),
            s!(1072, 1053), s!(1070, 1076), s!(1071, 1074), s!(1073, 1084), s!(1074, 1077), s!(1075, 1097), s!(1067, 1106), s!(1081, 1093),
            s!(1080, 1056), s!(1072, 1062), s!(1077, 1062), s!(1076, 1065), s!(1077, 1065), s!(1075, 1077), s!(1086, 1075), s!(1072, 1070),
            s!(1074, 1033), s!(1083, 1039), s!(1085, 1041), s!(1084, 1031), s!(1077, 1047), s!(1091, 1047), s!(1090, 1055), s!(1081, 1039),
            s!(1082, 1036), s!(1086, 1039), s!(1089, 1015), s!(1086, 1013), s!(1092, 1022), s!(1110,  971), s!(1097,  973), s!(1042, 1042),
            s!(1096, 1014), s!(1085, 1014), s!(1075, 1015), s!(1091,  999), s!(1083,  994), s!(1087,  970), s!(1003, 1026), s!(1033, 1035),
        ],
        [
            ...
            s!(1003, 1011), s!(1037, 1019), s!(1054, 1047), s!(1058, 1054), s!(1053, 1050), s!(1090, 1039), s!(1060, 1038), s!(1047, 1060),
        ...
        [
            ...
            s!(1034, 1051), s!(1030, 1056), s!(1025, 1071), s!(1023, 1091), s!(1021, 1090), s!(1035, 1088), s!(1036, 1084), s!(1050, 1084),
            s!(1054, 1020), s!(1033, 1059), s!(1041, 1056), s!(1050, 1062), s!(1039, 1089), s!(1046, 1066), s!(1052, 1055), s!(1042, 1066),
            s!(1046, 1008), s!(1059, 1008), s!(1064, 1034), s!(1059, 1019), s!(1052, 1052), s!(1064, 1018), s!(1058, 1029), s!(1053, 1031),
        ...
        [
            ...
            s!(1043, 1006), s!(1058, 1015), s!(1077, 1034), s!(1066, 1016), s!(1070, 1030), s!(1072, 1016), s!(1059, 1028), s!(1047, 1055),
            s!(1014, 1053), s!(1056, 1018), s!(1086,  977), s!(1072, 1014), s!(1060, 1026), s!(1059, 1016), s!(1049, 1020), s!(1062, 1038),
    ...
    [
        [
            ...
            s!( -20,   -7), s!( -20,  -10), s!( -17,  -13), s!(  -7,  -18), s!(  26,  -13), s!(  21,    9), s!(  10,    6), s!(   7,    8),
            s!( -22,  -28), s!( -22,  -28), s!( -38,   -1), s!(  -6,  -21), s!( -22,   25), s!(  50,   -6), s!(  55,   -8), s!(  -6,   25),
            s!( -21,  -15), s!( -23,   -4), s!(  -1,  -16), s!( -14,    9), s!(   8,    1), s!(  21,   10), s!(  35,   17), s!(  12,  -18),
            s!( -22,  -32), s!( -14,  -18), s!( -13,    5), s!(   5,   -9), s!(   2,    2), s!(   5,    5), s!( -11,   21), s!(  16,   -1),
            s!( -12,  -26), s!( -21,   -8), s!(   2,  -18), s!(  -4,    8), s!(  -0,    4), s!(  -4,   13), s!(  -4,    1), s!(  18,  -26),
            s!( -31,   -6), s!( -17,  -11), s!( -11,   -2), s!(  -4,   -8), s!(  -6,   -3), s!(  -7,   19), s!(   9,  -19), s!(   8,  -13),
        ...
        [
            ...
            s!( -22,    2), s!( -21,   17), s!( -31,   23), s!( -10,    4), s!(  23,   23), s!(  10,    6), s!( -30,   31), s!(  26,  -27),
            s!(  -7,   -2), s!( -15,   12), s!( -13,   15), s!( -11,   24), s!( -12,   35), s!(  -6,   28), s!(   2,    3), s!(  -1,    3),
            s!( -15,    9), s!( -13,    5), s!(  -6,   16), s!(  -6,   18), s!(  -5,   14), s!(  -2,    4), s!(   6,    2), s!(  10,    2),
            s!(  -2,   -9), s!(  -8,   13), s!(  -8,   11), s!(  -9,   14), s!(   0,    1), s!(  -0,   -0), s!(   5,    1), s!(  11,   -8),
            s!(  -3,   -6), s!( -11,   11), s!(  -5,    8), s!(  -1,    3), s!(  -6,    1), s!(   1,  -12), s!(  29,  -48), s!(   3,   -1),
            s!(  -9,   -5), s!(   1,  -17), s!(  10,  -17), s!(  -7,    9), s!(   5,  -12), s!(   1,  -15), s!(  13,  -27), s!(  -3,    3),
        ],
        [
        ...
        [
            ...
            s!(   1,    2), s!(  -0,   24), s!(  15,   17), s!(  -2,   10), s!(  14,   19), s!(  14,    4), s!(   2,    6), s!(  11,    8),
            s!(  -1,   25), s!(  13,   19), s!(   7,    6), s!(  -7,    0), s!(  -2,   16), s!(   8,  -15), s!(  -1,    2), s!(   1,    5),
            s!(   7,   20), s!(  -2,   31), s!(  -8,   11), s!(  -6,  -25), s!(   5,   -5), s!(  -3,   -6), s!(  11,  -25), s!(   9,  -20),
            s!(  -3,    1), s!(   5,   -2), s!(  -2,  -23), s!(  -9,   -2), s!(   1,  -13), s!( -14,    6), s!(  10,   -7), s!(   2,    0),
        ...
        [
            ...
            s!(   6,    5), s!(   5,    3), s!(   6,  -26), s!( -14,  -11), s!(  -4,   -5), s!(   2,   -6), s!( -23,   10), s!( -29,    4),
        ...
        [
            ...
            s!(  11,   -1), s!(   7,   17), s!(  21,   14), s!(  27,    8), s!( -25,    9), s!( -47,  -10), s!( -52,   -8), s!( -25,  -34),
            s!( -10,   12), s!(  14,   -8), s!(  -1,   16), s!(  21,    7), s!(   1,   -3), s!( -22,   19), s!( -23,   -3), s!( -28,  -21),
            s!(   6,  -14), s!(  11,   10), s!(  -0,   -1), s!(  14,  -10), s!(  11,    3), s!(  -9,   -3), s!( -13,  -13), s!( -11,  -19),
            s!(  -7,   11), s!(   8,  -13), s!(  -0,   -0), s!(   6,   -0), s!(  16,    1), s!(   6,   -4), s!(  -0,    7), s!( -11,  -16),
