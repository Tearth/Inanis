...
pub fn evaluate(board: &Bitboard, dangered_white_king_squares: &mut u32, dangered_black_king_squares: &mut u32) -> EvaluationResult {
...
fn evaluate_color(board: &Bitboard, color: u8, dangered_king_squares: &mut u32) -> EvaluationResult {
